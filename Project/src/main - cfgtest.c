...
void SaveConfig()
{
  if( gIsConfigChanged ) {
    ...
    printlog("n=");
    printnum(gConfig.NetworkID[0]);
    printlog(" ");
    printnum(gConfig.NetworkID[1]);
    printlog(" ");
    printnum(gConfig.NetworkID[2]);
    printlog(" ");
    printnum(gConfig.NetworkID[3]);
    printlog(" ");
    printnum(gConfig.NetworkID[4]);
    printlog(" ");
    printnum(gConfig.NetworkID[5]);
    printlog(" ");
